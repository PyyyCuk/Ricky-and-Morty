...
//        let favouritesNavController = UINavigationController(rootViewController: favouritesVC)
        ...
        episodesVC.tabBarItem = UITabBarItem(title: "Episodes", image: UIImage(systemName: "house"), tag: 0)
//        favouritesVC.tabBarItem = UITabBarItem(title: "Favourites", image: UIImage(systemName: "heart"), tag: 1)
        tabBar.viewControllers = [episodesNavController]
